            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right font-medium">$55.000 por día</td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right font-medium">$92.000 por día</td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right font-medium">$105.000 por día</td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right font-medium">$150.000 por día</td>
                </tr>
              </tbody>
            </table>
          </div>
