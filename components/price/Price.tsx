      ...
      <Table celled className="styled-table">
        ...
        <Table.Body style={{ textAlign: "center" }}>
          ...
          <Table.Row>
            ...
            <Table.Cell>Desde $59.000 por día</Table.Cell>
          </Table.Row>
        </Table.Body>
      </Table>
    </div>
