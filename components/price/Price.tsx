      ...
      <Table celled className="styled-table">
        ...
        <Table.Body style={{ textAlign: "center" }}>
          <Table.Row>
            ...
            <Table.Cell>Desde $45.000 por día</Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>Para 3 personas</Table.Cell>
            {/* <Table.Cell>$15.200 por día</Table.Cell> */}
            <Table.Cell>Desde $50.000 por día</Table.Cell>
          </Table.Row>
          <Table.Row>
          ...
          <Table.Row>
            ...
            <Table.Cell>Desde $71.000 por día</Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>
            ...
            <Table.Cell>Desde $82.000 por día</Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>
            ...
            {/* <Table.Cell>$25.600 por día</Table.Cell> */}
            <Table.Cell>Desde $120.000 por día</Table.Cell>
          </Table.Row>
        </Table.Body>
      </Table>
    </div>
