    ...
    <>
      <div className="sm:py-15 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <span>
            Nuestro complejo esta ubicado sobre el rio, en Arroyo Leyes, Santa Fe. Ruta 1, km 22. Yendo para el norte,
            es pasando el primer puente de hierro 300 metros a mano derecha, (la segunda bajada). A 25 kilometros de la
            capital.
          </span>
        </div>
        ...
        <div className="text-center">
          ...
          <span>Lo único que NO incluyen las cabañas son toallas y toallones.</span>
        </div>
        <div className="text-center">
          <p className="mt-1 text-4xl font-bold uppercase text-gray-900 sm:text-5xl sm:tracking-tight lg:text-5xl">
            COMO RESERVAR?
          ...
          <span>
            La reserva se la tomamos vía telefónica o por whatsapp. Estamos trabajando con una seña del 50% al momento
            de reservar por banco, y el resto se abona antes de ingresar al complejo por banco/mercadopago o en el
            complejo mismo.
          </span>
        </div>
      </div>
